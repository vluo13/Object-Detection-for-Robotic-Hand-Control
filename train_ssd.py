...
from vision.datasets.fruit_dataset import Custom_Dataset
...
parser.add_argument('--freeze-net', action='store_true', default = True,  
...
if __name__ == '__main__':
    ...
    for dataset_path in args.datasets:
        if args.dataset_type == 'fruit':
            dataset = Custom_Dataset("data/train",
    ...
    if args.dataset_type == "fruit":
        val_dataset = Custom_Dataset("data/test", transform=test_transform,
    ...
    if args.resume:
        ...
        net.init_from_pretrained_ssd('models/mb2-ssd-lite-mp-0_686-pretrained-VOC.pth')#args.pretrained_ssd)
